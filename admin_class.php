...
Class Action {
	...
	function delete_employee(){
		extract($_POST);
		$delete_allowance=$this->db->query("DELETE FROM employee_allowances where employee_id = ".$id);
		$delete_deduction=$this->db->query("DELETE FROM employee_deductions where employee_id = ".$id);
		$delete_deduction=$this->db->query("DELETE FROM attendance where employee_id = ".$id);
		$delete_deduction=$this->db->query("DELETE FROM payroll_items where employee_id = ".$id);
