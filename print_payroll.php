...
<table>
    ...
    <?php
        ...
        $payroll=$conn->query("SELECT p.*,concat(e.firstname,' ',e.middlename,' ',e.lastname) as ename,e.employee_no,e.salary FROM payroll_items p inner join employee e on e.id = p.employee_id ") or die(mysqli_error());
